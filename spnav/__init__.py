...
class spnav_event_motion(Structure):
    ...
    '''
    _fields_ = [
        ('type', c_int), ('x', c_int), ('y', c_int), ('z', c_int), ('rx', c_int), ('ry', c_int),
        ('rz', c_int), ('period', c_uint), ('data', c_void_p)
        ]
...
class spnav_event(Union):
    ...
    A C union between the motion and button event structs.
      ...
      `button`: spnave_event_button,
        ...
        is a motion event C struct.
    '''
    _fields_ = [('type', c_int), ('motion', spnav_event_motion), ('button', spnav_event_button)]
